...
ROLE_CORE_TEAM = int(os.getenv('ROLE_CORE_TEAM'))
ROLE_EVENT_HEAD = int(os.getenv('ROLE_EVENT_HEAD'))
ROLE_VOLUNTEER = int(os.getenv('ROLE_VOLUNTEER'))
...
async def on_ready():
    ...
    manage_team.core_team_role = handle_verification.guild.get_role(ROLE_CORE_TEAM)
    manage_team.event_head_role = handle_verification.guild.get_role(ROLE_EVENT_HEAD)
    manage_team.volunteer_role = handle_verification.guild.get_role(ROLE_VOLUNTEER)
    print("I am ready")
